...
while(matched=s.message.match(/\#\s*<img[^\>]*?title=\"\[\s*(doge|eh|a|bgx|bs|dmz|guai|h|han|hh|hhh|hj|huanxin|hx|jy|kh|ku|kx|lei|leng|mq|pen|q|sj|sl|t|tkx|ts|wq|xy|y|yw|yx|zb)\s*\]\"[^\>]*?class=\"ds\-smiley\"[^\>]*?>/)) {
    s.message = s.message.replace(matched[0], "<img src=\"/static/img/bqb/" + matched[1].trim() + subfix + ".png\" class=\"biaoqing paopao\" height=32 width=32 no-zoom />");
}
while(matched=s.message.match(/\#\[\s*(doge|eh|a|bgx|bs|dmz|guai|h|han|hh|hhh|hj|huanxin|hx|jy|kh|ku|kx|lei|leng|mq|pen|q|sj|sl|t|tkx|ts|wq|xy|y|yw|yx|zb)\s*\]/)) {
    s.message = s.message.replace(matched[0], "<img     src=\"/static/img/bqb/" + matched[1] + subfix + ".png\" class=\"biaoqing paopao\" height=32 width=32 no-zoom />");
}
            /*自定义表情END*/
    ...
    "#[呵呵]":"hh","#[哈哈]":"hhh","#[吐舌]":"ts","#[啊]":"a","#[酷]":"ku","#[开心]":"kx","#[汗]":"han","#[泪]":"lei","#[黑线]":"hx",
    "#[鄙视]":"bs","#[不高兴]":"bgx","#[真棒]":"zb","#[疑问]":"yw","#[阴险]":"yx","#[吐]":"t","#[咦]":"y","#[委屈]":"wq","#[花心]":"huaxin",
    "#[呼]":"h","#[笑眼]":"xy","#[冷]":"leng","#[太开心]":"tkx","#[滑稽]":"hj","#[勉强]":"mq","#[狂汗]":"kh","#[乖]":"guai","#[睡觉]":"sj",
    "#[惊讶]":"jy","#[喷]":"pen","#[胜利]":"sl","#[大拇指]":"dmz","#[doge]":"doge","#[二哈]":"eh"
    ...
    i = "/static/img/bqb/" + s + subfix + ".png";
}

                        "WordPress" === e && (t = " " + t + " "), a += '<li><img src="' + i + '" title="' + _(t) + '" width=32 height=32 /></li>'
                    }
